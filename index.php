...
<html lang="en">
	<head>
	    ...
	    <title>E-Shopping Cart Home Page</title>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">PC & Laptop</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysql_query("select * from products where category=2");
while ($row=mysql_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">TV</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysql_query("select * from products where category=4");
while ($row=mysql_fetch_array($ret)) 
{
?>
